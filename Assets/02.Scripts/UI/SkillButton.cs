...
namespace lsy
{
    public class SkillButton : CombatButton
    {
        ...
        protected override void Awake()
        {
            ...
            rectTransform.localScale = new Vector2(ValueData.SkillButtonTransitionScale, ValueData.SkillButtonTransitionScale);
        }
        ...
        {
            rectTransform.DOAnchorPos(originPosition, ValueData.SkillButtonTransitionTime);
            rectTransform.DOScale(ValueData.SkillButtonTransitionScale, ValueData.SkillButtonTransitionTime);
        }
